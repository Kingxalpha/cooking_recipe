...
function Mastering() {
  ...
  return (
    <div className='bg-[#F0EBE1] p-3'>
          ...
          {basics.map((basics, index) => (
            <div key={index} className=''>
              <div className=''>
                ...
                <div className='flex flex-col bg-[#F0EBE1] text-black lg:w-[84%] sm:w-[100%] mb-3 p-2 shadow-lg rounded-br-xl rounded-bl-xl'>
        ...
        <div className='lg:flex lg:flex-row sm:flex-col lg:items-center lg:justify-between lg:mt-2 lg:gap-5'>
