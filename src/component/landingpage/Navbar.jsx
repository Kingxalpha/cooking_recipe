  ...
  return (
    <div>
      <div className='w-[100%] flex items-center justify-center'>
        <nav className='flex justify-between w-[100%] items-center p-3 bg-[#fff] rounded-lg sm:w-[100%] sm:p-[10px]' onClick={toggleMenu}>
          <div>
            <Image height={100} width={100} src={"/Log.png"}/>
          </div>
          <ul className='flex gap-10 text-black sm:hidden md:hidden text-2xl justify-between'>
      ...
      <ul className={`${isMenuOpen? "block" : "hidden"  } flex flex-col gap-3 items-center justify-center text-white h-[40vh] transition duration-300 ease-in-out lg:hidden mt-6 z-[999] bg-red-900`}>
