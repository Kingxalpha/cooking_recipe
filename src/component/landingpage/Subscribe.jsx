...
function Subscribe() {
  return (
    <div  className='bg-cover bg-center bg-no-repeat w-[100%] h-[85vh] sm:h-[55vh]' style={{ backgroundImage: 'url(/group.png)' }}>
        <div className='flex flex-col items-center justify-center lg:h-[80vh] sm:h-[55vh] p-3  '>
            ...
            <div className='lg:bg-white rounded-xl sm:flex sm:flex-col sm:gap-2'>
