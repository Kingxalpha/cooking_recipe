  ...
  return (
    <div className='bg-[#C4E5FC] lg:flex lg:flex-row lg:p-10'>
        <div className='sm:flex sm:flex-col sm:px-3 lg:mt-20'>
            <p className='p-2 px-3 rounded-xl border-2 bg-[#EE6352] sm:w-[30%] lg:w-[10%] mt-4'>Explore</p>
            <h2 className='sm:w-[50%] sm:mt-2 text-black sm:font-bold'>Our Diverse Pallete</h2>
            ...
            <Link href="/" passHref>
            <button className='p-2 px-3 rounded-xl mt-3 border border-black hover:bg-[#f29c33] hover:border-none text-black hover:text-[#fff] hover:duration-100 hover:transition cursor-pointer'>
            See More
            </button>
        </Link>
        </div>
